...
M.load_plugin_syntax = function(p)
  return {
    ...
    ["@lsp.type.struct"]                        = {},
    ["@lsp.typemod.struct.defaultLibrary"]      = { fg = p.cyan },
    ...
    ["@lsp.typemod.enum.defaultLibrary"]        = { fg = p.cyan_dim },

    ["@lsp.type.enumMember"]                    = { fg = p.orange },
    ["@lsp.typemod.enumMember.defaultLibrary"]  = { fg = p.cyan },

    ["@lsp.type.type"]                          = {},
    ["@lsp.typemod.type.defaultLibrary"]        = { fg = p.cyan_dim },
    ["@lsp.typemod.type.bool"]                  = { fg = p.red_light },

    ["@lsp.type.typeAlias"]                     = { fg = p.yellow_dim },
    ["@lsp.typemod.typeAlias.defaultLibrary"]   = { fg = p.cyan_dim },
